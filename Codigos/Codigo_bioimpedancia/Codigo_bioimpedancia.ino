...
float fat = (1/(mag * 1000)) * 0.85 +3.04; 
float fatPer = (fat/pesoPaciente) * 100; // el 70 es valor referencia 
      ...
      Serial.print("Grasa Corporal: ");
      Serial.print(fat);

      Serial.print ("Porcenta Grasa: ");
      Serial.print (fatPer);
